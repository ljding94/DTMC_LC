...
def main():
    ...
    #config_plot3D("../data/Ne1/Mar23_2021/State_N500_Ne1_L-1_kar100_karg0.0_lam6.0_Kd7.0_q4.0_Cn7.0_kard0.0.txt",mesh=1,rod=0)
    #config_plot3D("../data/Ne1/Mar23_2021/State_N500_Ne1_L-1_kar100_karg0.0_lam6.0_Kd7.0_q6.0_Cn7.0_kard0.0.txt",mesh=1,rod=0)
    config_plot3D("../data/Ne2/Mar26_2021/State_N200_Ne2_L0_kar100_karg0.0_lam6.0_Kd3.0_q0.9_Cn5.0_kard0.0.txt",mesh=1,rod=0)
    #config_plot3D("../data/scratch_local/State_N200_Ne2_L0_kar100_karg0.0_lam6.0_Kd3.0_q0.0_Cn3.0_kard0.0_init.txt",mesh=1,rod=1)
    #config_plot3D("../data/scratch_local/State_N200_Ne2_L0_kar100_karg0.0_lam6.0_Kd3.0_q0.0_Cn3.0_kard0.0.txt",mesh=1,rod=1)
    ...
    foldername = "../data/Ne2/Mar26_2021" # kinda switch to Ne2 simulation for next paper
