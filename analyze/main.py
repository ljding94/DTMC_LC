...
def main():
    ...
    #config_plot3D("../data/Ne2/Mar20_2021/State_N200_Ne2_L0_kar100_karg0.0_lam6.0_Kd7.0_q0.6_Cn5.0_kard0.0.txt",mesh=0,rod=1)
    #config_plot3D("../data/Ne2/Mar20_2021/State_N200_Ne2_L0_kar100_karg0.0_lam6.0_Kd7.0_q1.4_Cn5.0_kard0.0.txt",mesh=0,rod=1)
    ...
    #foldername = "../data/Ne2/Mar20_2021" # kinda switch to Ne2 simulation for next paper
    ...
    L=-1 # -1 for circular initialization
